...
const Summary = ({ userAnswers }) => {
    ...
    const correctedAnswers = userAnswers.filter((answer, index) => answer === Questions[index].answers[0]);

    const skippedAnswersShare = Math.round(skippedAnswers.length / userAnswers.length * 100);
    const correctedAnswersShare = Math.round(correctedAnswers.length / userAnswers.length * 100);
